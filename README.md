...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gi-utcm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gi-utcm.containers.anotherwebservice.com/
...
```
git clone git@github.com:taoday12/container-gi-utcm.git
cd container-gi-utcm
```
...
```
docker attach container-gi-utcm
```
